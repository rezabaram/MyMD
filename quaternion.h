...
Quaternion(double a, const vec3d &_v);

void set(double u,double x,double y,double z);
void set(const vec3d &axis, double angle);
void set(double angle, const vec3d &axis);
void setRotation(const vec3d &_V, double _a);
...
friend Quaternion operator*(const Quaternion &,const Quaternion &);
friend Quaternion operator*(const Quaternion &,const vec3d &);
friend Quaternion operator*(const vec3d &,const Quaternion &);
...
inline void Quaternion::set(double _a, const vec3d &_V){
u=_a;  
v=_V;
}

inline Quaternion::Quaternion(  const vec3d &_V, double _a){
set(_a,_V);
}

inline Quaternion::Quaternion( double _a, const vec3d &_V){
set(_a,_V);
}

inline void Quaternion::setRotation(const vec3d &_V, double _a){
u=cos(_a/2);
...
inline Quaternion operator*(const Quaternion &q,const vec3d &v){
return Quaternion(-q.v*v, q.u*v+cross(q.v,v));
}

inline Quaternion operator*(const vec3d &v,const Quaternion &q){
return Quaternion(-q.v*v, q.u*v+cross(v,q.v));
}

inline Quaternion &Quaternion::operator=(const vec3d &_v){
u=0; 
v=_v;
return *this;
}

inline vec3d Quaternion::rotate(const vec3d &v)const{
...
inline void Quaternion::rotateMe(const vec3d &axis, double angle){
...
*/
inline vec3d Quaternion::toBody(const vec3d &_v){
